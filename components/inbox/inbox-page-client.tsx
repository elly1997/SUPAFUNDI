...
export function InboxPageClient() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Inbox"
        description="Approvals and daily closing for every outlet. Owner and managers only."
      />
      ...
      {isLoading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center gap-2 py-12 text-center text-sm text-muted-foreground">
            ...
            Nothing waiting. New transfer and void requests from staff will
            appear here, along with unreconciled days per outlet.
          </CardContent>
        </Card>
      ) : (
        <div className="space-y-3">
          {items.map((item) => {
            ...
            const busy =
              transferMut.isPending || voidMut.isPending;
            return (
                    ...
                    {item.kind === "transfer_approval" ? (
                      <>
                        <Button
                          ...
                          disabled={busy}
                          onClick={() =>
                            transferMut.mutate(item.referenceId)
                          }
                        >
                          Approve & send
                        </Button>
